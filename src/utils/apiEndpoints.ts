...
const paths = {
  auth: {
    ...
    sessions: "/api/sessions/my-sessions",
    deleteSession: "/api/sessions",
    refresh: "/api/auth/refresh-token",
    logout: "/api/auth/logout",
  },
  contacts: {
    add: "/api/contacts/add",
    verify: "/api/contacts/verify",
    update: {
      initiate: "/api/contact-update/initiate",
      validate: "/api/contact-update/validate-otp",
      complete: "/api/contact-update/complete",
      status: "/api/contact-update/status",
      active: "/api/contact-update/active-requests",
      canInitiate: "/api/contact-update/can-initiate",
      resend: "/api/contact-update/resend-otp",
      cancel: "/api/contact-update/cancel",
    },
  },
  users: {
    base: "/api/users",
  ...
  kyc: {
    base: "/api/kyc",
    hasVerification: "/api/kyc/has-verification",
    isVerified: "/api/kyc/is-verified",
    submit: "/api/kyc",
    submitLegacy: "/api/kyc/submit",
  },
  media: {
    base: "/api/media",
    importOne: "/api/media/import",
    types: "/api/media/types",
    upload: "/api/media/upload",
  },
  guest: {
    store: "/api/guest/store",
  },
  subscription: {
    ...
    subscriptions: "/souscription/api/v1/subscriptions",
...
export const API_ENDPOINTS: Endpoints = {
  ...
  SUBSCRIPTION: {
    APPLICATIONS: joinBase(paths.subscription.getAllApplications || paths.subscription.applications),
    FEATURES: joinBase(paths.subscription.features),
    FEATURES_BY_APPLICATION: (appId: string) =>
      joinBase(`/souscription/api/v1/features/application/${appId}`),
    PLANS: joinBase(paths.subscription.plans),
    PLANS_BY_APPLICATION: (appId: string) =>
      joinBase(`/souscription/api/v1/plans/application/${appId}`),
    PLAN_FEATURES: joinBase(paths.subscription.planFeatures),
    PLAN_FEATURES_BY_PLAN: (planId: string) =>
      joinBase(`/souscription/api/v1/plan-features/plan/${planId}`),
    SUBSCRIPTIONS: joinBase(paths.subscription.subscriptions),
...
export const endpointCatalog: EndpointCatalogEntry[] = [
  ...
  },
  {
    ...
    method: "GET",
    path: API_ENDPOINTS.SUBSCRIPTION.APPLICATIONS,
  ...
  },
  {
    ...
    method: "GET",
    path: API_ENDPOINTS.SUBSCRIPTION.FEATURES,
    folder: "Souscriptions",
    pages: ["applications"],
  },
  {
    ...
    method: "GET",
    path: API_ENDPOINTS.SUBSCRIPTION.PLANS,
    folder: "Souscriptions",
    pages: ["applications", "subscriptions"],
  },
  {
    id: "promotions-create",
    label: "Créer une promotion",
    method: "POST",
    path: API_ENDPOINTS.SUBSCRIPTION.PROMOTIONS,
    folder: "Souscriptions",
    pages: ["applications", "subscriptions"],
  },
  {
    ...
    label: "Abonnements",
    method: "GET",
    path: API_ENDPOINTS.SUBSCRIPTION.SUBSCRIPTIONS,
    folder: "Souscriptions",
    pages: ["subscriptions", "stats"],
  },
  {
    id: "subscriptions-get-or-create",
    label: "Get or Create Subscription",
    method: "GET",
    path: materializePath(API_ENDPOINTS.SUBSCRIPTION.GET_OR_CREATE_SUBSCRIPTION, [
      ":contextId",
      ":contextType",
    ]),
    folder: "Souscriptions",
  ...
  },
  {
    ...
    method: "POST",
    path: API_ENDPOINTS.SUBSCRIPTION.QUOTA.CONSUME,
    folder: "Souscriptions",
    pages: ["subscriptions", "stats"],
  },
  {
    ...
    method: "POST",
    path: API_ENDPOINTS.SUBSCRIPTION.QUOTA.CHECK,
    folder: "Souscriptions",
    pages: ["subscriptions"],
  },
  {
